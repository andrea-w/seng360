...
public class ServerOperation extends UnicastRemoteObject implements RmiInterface {
	...
	private static List<ClientCallBack> clients = new ArrayList<ClientCallBack>();
	...
	public static void confidentiality() throws MalformedURLException, RemoteException, NotBoundException, Exception {
		...
		while(true) {
			...
			for (ClientCallBack callBack : ServerOperation.clients) {
				callBack.helloTo("server want to " + txt);
			}
//			String response = look_up.helloTo(txt);
//
